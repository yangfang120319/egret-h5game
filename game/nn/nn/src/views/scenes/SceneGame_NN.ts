 ...
 *
 */
class SceneGame_NN extends basic.SceneBase {
    //定义变量
    ...
    public constructor() {
        ...
        //定义界面
        this.skinName = SceneGame_NNSkin;
        ...
        for(var i: number = 0;i < 5;i++) {
            //定义变量
            var now_table: NN_Table = this["table" + i];
        ...
        basic.Dispatcher.addListener(EventNames.NN_ERROR,this.onShowTips,this);
        basic.Dispatcher.addListener(EventNames.NN_SHOWGOLD,this.onShowGold,this);
        basic.Dispatcher.addListener(EventNames.NN_GAMEOPEN,this.onGameOpen,this);
        basic.Dispatcher.addListener(EventNames.NN_GAMEINFO,this.onGameInfo,this);
        basic.Dispatcher.addListener(EventNames.NN_ENTERROOM,this.onEnterRoom,this);
        basic.Dispatcher.addListener(EventNames.NN_GAMERESULT,this.onGameResult,this);
        basic.Dispatcher.addListener(EventNames.NN_CHANGEZHUANG,this.onChangeZhuang,this);
        basic.Dispatcher.addListener(EventNames.NN_CHANGESTATUS,this.onChangeStatus,this);
        basic.Dispatcher.addListener(EventNames.NN_SEND_CARDOVER,this.onSendCardOver,this);
    ...
    private showClock(_time: number = 0): void {
        ...
        if(GameData.NN_Game_Status == 0) {
            ...
            this.clock.startTimer(GameData.NN_Game_Status,_time - 2,() => {
                //数据赋值
    ...
    private onChangeStatus(e: egret.Event): void {
        ...
        if(GameData.NN_Game_Status == 0) {
            ...
            //显示倒计时
            this.clock.startTimer(GameData.NN_Game_Status,e.data.leftTime - 2,() => {
                //数据赋值
                GameData.NN_Game_Status = 2;
            });
