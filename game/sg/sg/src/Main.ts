...
class Main extends eui.UILayer {
    ...
    private onResourceLoadComplete(event: RES.ResourceEvent): void {
        ...
        if(event.groupName == "loading") {
            ...
            //开始加载开始资源
            RES.loadGroup("sgload");
        }
        else if(event.groupName == "sgload") {
            //数据赋值
    ...
    private checkShowLoading() {
        ...
        basic.SceneManager.register(SceneNames.GAME_SG,SceneGame_SG);
    ...
    private startCreateScene() {
        ...
        if(LoaderData.is_Start_Show == false) {
            //显示开始界面
            basic.SceneManager.show(SceneNames.GAME_SG,null,basic.sceneEffect.Fade);
        }
