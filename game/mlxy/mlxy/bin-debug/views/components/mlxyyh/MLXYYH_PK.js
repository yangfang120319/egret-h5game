 ...
 *
 */
var MLXYYH_PK = (function (_super) {
    __extends(MLXYYH_PK, _super);
    function MLXYYH_PK() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this._tween_X_Left = null;
        _this._tween_Y_Left = null;
        _this._tween_alpha_Left = null;
        _this._tween_scaleX_Left = null;
        _this._tween_scaleY_Left = null;
        _this._tween_X_Right = null;
        _this._tween_Y_Right = null;
        _this._tween_alpha_Right = null;
        _this._tween_scaleX_Right = null;
        _this._tween_scaleY_Right = null;
        _this._tween_alpha_Back = null;
        _this._tween_pk_alpha = null;
        _this._tween_pk_scaleX = null;
        _this._tween_pk_scaleY = null;
        _this._tween_pk_add_alpha = null;
        _this._tween_pk_add_scaleX = null;
        _this._tween_pk_add_scaleY = null;
        _this._tween_light_alpha = null;
        _this._tween_pk_add_rotation = null;
        _this._tween_Y_Luck = null;
        _this.timer_doudong = null;
        _this.timer_waiting1 = null;
        _this.timer_waiting2 = null;
        return _this;
    }
    //初始化
    MLXYYH_PK.prototype.createChildren = function () {
    ...
    //初始化界面
    MLXYYH_PK.prototype.info = function (_run_rate, _left_run_x, _left_run_y, _rightt_run_x, _rightt_run_y) {
        //定义变量
        var rate = (basic.StageProxy.width - 830) / 306;
        //数据赋值
    ...
    //开始
    MLXYYH_PK.prototype.start = function () {
        var _this = this;
        //显示左边
    ...
    //开始动画
    MLXYYH_PK.prototype.startAction = function () {
        var _this = this;
        //显示界面
        this.visible = true;
        this.baozha.clean();
        ...
        this._tween_scaleY_Right = egret.Tween.get(this.img_right).wait(300).
            to({ scaleY: 1 }, 400).call(function () {
            //显示界面
            _this.img_left.alpha = 1;
            _this.img_right.alpha = 1;
            _this.img_left.visible = true;
            _this.img_right.visible = true;
            _this.img_left.source = "icon_mlxyyh_" + GameData.MLXYYH_BoxNum_Left[GameData.MLXYYH_RunOver_Left] + "_2_png";
            _this.img_right.source = "icon_mlxyyh_" + GameData.MLXYYH_BoxNum_Right[GameData.MLXYYH_RunOver_Right] + "_2_png";
            //显示图表抖动
            _this.startDouDong();
        });
        //显示PK动画
    ...
    //等待结束1
    MLXYYH_PK.prototype.onShowWaitingComplete1 = function (e) {
        var _this = this;
        //判断停止
        ...
        this._tween_pk_add_alpha = egret.Tween.get(this.img_pk_add).to({ alpha: 0 }, 200).call(function () {
            //隐藏
            _this._tween_pk_add_alpha = egret.Tween.get(_this.img_pk_add).wait(1800).
                to({ alpha: 1 }, 200).
                to({ alpha: 0 }, 200);
            //显示闪电
            _this.shandian1.start(2, 1);
            _this.shandian2.start(2, 0);
        });
    };
    //等待结束2
    MLXYYH_PK.prototype.onShowWaitingComplete2 = function (e) {
        var _this = this;
        //判断停止
        ...
        //定义变量
        var move_overX = (basic.StageProxy.width - this.img_left.width) / 2;
        //停止抖动
        this.stopDouDong();
        //显示移动动画
        ...
        this._tween_X_Right = egret.Tween.get(this.img_right).
            to({ x: move_overX + this.img_left.width / 2 - 30 }, 100).call(function () {
            //显示爆炸
            _this.baozha.start();
            //继续运动
            _this._tween_X_Left = egret.Tween.get(_this.img_left).
                to({ x: move_overX }, 50);
            _this._tween_X_Right = egret.Tween.get(_this.img_right).
                to({ x: move_overX }, 50).wait(100).call(function () {
                //判断显示结束动画
                _this.showOverAction();
            });
        });
    };
    //显示结束动画
    MLXYYH_PK.prototype.showOverAction = function () {
        //判断显示动画
    ...
    //开始抖动
    MLXYYH_PK.prototype.startDouDong = function () {
        //开始抖动
    ...
    //抖动中
    MLXYYH_PK.prototype.onShowDouDong = function (e) {
        //判断显示移动Left
        var over_left_x = this.left_moveover_x + (15 - Math.random() * 30);
        var over_left_y = this.left_moveover_y + (15 - Math.random() * 30);
        //显示移动
        this._tween_X_Left = egret.Tween.get(this.img_left).
            to({ x: over_left_x }, 60);
        this._tween_Y_Left = egret.Tween.get(this.img_left).
            to({ y: over_left_y }, 60);
        //判断显示移动Right
        var over_right_x = this.right_moveover_x + (30 - Math.random() * 60);
        var over_right_y = this.right_moveover_y + (30 - Math.random() * 60);
        //显示移动
        this._tween_X_Right = egret.Tween.get(this.img_right).
    ...
    //结束抖动
    MLXYYH_PK.prototype.stopDouDong = function () {
        //判断停止
    ...
    //显示发光动画
    MLXYYH_PK.prototype.showLightAction = function () {
        var _this = this;
        //显示界面
        ...
        this._tween_light_alpha = egret.Tween.get(this.g_light).to({ alpha: 1 }, 200).call(function () {
            _this._tween_pk_add_rotation = egret.Tween.get(_this.g_light, { loop: true }).
                to({ rotation: 360 }, 5000);
        });
    };
    //隐藏PK
    MLXYYH_PK.prototype.onHidePK = function (e) {
        //隐藏界面
        this.visible = false;
        //停止动画
        this.stopAction();
    ...
    //停止动画 
    MLXYYH_PK.prototype.stopAction = function () {
...
__reflect(MLXYYH_PK.prototype, "MLXYYH_PK");
//# sourceMappingURL=MLXYYH_PK.js.map