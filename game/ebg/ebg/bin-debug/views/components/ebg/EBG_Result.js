...
var EBG_Result = (function (_super) {
    ...
    //显示结果
    EBG_Result.prototype.show = function (_table_num, _callback) {
        var _this = this;
    ...
    //直接显示结果
    EBG_Result.prototype.showResult = function (_table_num) {
        //数据赋值
        this.table_num = _table_num;
        //数据赋值
        this.assData();
    ...
    EBG_Result.prototype.startAction1 = function () {
        ...
        this._tween_alpha = egret.Tween.get(this.img_num1).to({ alpha: 1 }, 100).call(function () {
            _this._tween_alpha = egret.Tween.get(_this.img_dian).to({ alpha: 1 }, 100).call(function () {
    ...
    EBG_Result.prototype.startAction2 = function () {
        ...
        this._tween_alpha = egret.Tween.get(this.img_num2).to({ alpha: 1 }, 100).call(function () {
            if (_this.fun_callback) {
                _this.fun_callback();
            }
        });
    ...
    EBG_Result.prototype.startAction3 = function () {
        ...
        this._tween_alpha = egret.Tween.get(this.img_num3).to({ alpha: 1 }, 100).call(function () {
            if (_this.fun_callback) {
                _this.fun_callback();
            }
        });
...
//# sourceMappingURL=EBG_Result.js.map