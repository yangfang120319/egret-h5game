 ...
 *
 */
var Panel_EBG_LuZi = (function (_super) {
    __extends(Panel_EBG_LuZi, _super);
    //定义界面
    function Panel_EBG_LuZi() {
    ...
    Object.defineProperty(Panel_EBG_LuZi, "instance", {
        get: function () {
            if (this._instance == undefined) {
                this._instance = new Panel_EBG_LuZi();
            }
    ...
    //皮肤设置
    Panel_EBG_LuZi.prototype.init = function () {
        this.skinName = Panel_EBG_LuZiSkin;
    };
    //初始化界面
    Panel_EBG_LuZi.prototype.createChildren = function () {
    ...
    //显示界面
    Panel_EBG_LuZi.prototype.show = function (callback) {
    ...
    //退出函数
    Panel_EBG_LuZi.prototype.funExit = function () {
        //退出事件
        this.dealAction();
    };
    //显示内容界面
    Panel_EBG_LuZi.prototype.onShowDetail = function (e) {
        //隐藏界面
        for (var i = 0; i < 8; i++) {
    ...
    //退出按钮
    Panel_EBG_LuZi.prototype.onCloseBtn = function (e) {
        //播放声音
        basic.SoundManager.instance.playEffect("sound_btn_mp3");
        //退出设置
        this.funExit();
    };
    return Panel_EBG_LuZi;
}(basic.PanelBase));
__reflect(Panel_EBG_LuZi.prototype, "Panel_EBG_LuZi");
//# sourceMappingURL=Panel_EBG_LuZi.js.map