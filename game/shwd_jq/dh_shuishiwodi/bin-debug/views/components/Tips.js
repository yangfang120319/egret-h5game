...
var Tips = (function (_super) {
    ...
    Tips.prototype.show = function (_tips) {
        ...
        //显示界面
        this.is_show = true;
        this._tween_alpha = egret.Tween.get(this).wait(1100).to({ alpha: 0 }, 300);
        this._tween_y = egret.Tween.get(this).to({ y: (basic.StageProxy.height - this.height) / 2 }, 300).
            wait(2000).to({ y: -this.height }, 300).call(function () {
            //数据赋值
            _this.is_show = false;
            //停止欢动
            if (_this._tween_y) {
