...
class GameData {
    ...
    //-------------------夜市场-----------------------
    //压住
    static YSC_RUN_OVER: number;
    static YSC_YaZhu_UserTotal: number;
    static YSC_QiangZhu_UserTotal: number;
    static YSC_YaZhu_User: number[] = [0,0,0,0];
    static YSC_YaZhu_Total: number[] = [0,0,0,0];
    static YSC_QiangZhu_User: number[] = [0,0,0,0];
    static YSC_QiangZhu_Total: number[] = [0,0,0,0];
    static YSC_Now_YaZhu_User: number[] = [0,0,0,0];
    static YSC_Now_QiangZhu_User: number[] = [0,0,0,0];
    static YSC_Now_YaZhuDetail_User: any[] = [[],[],[],[]];
    static YSC_Now_QiangZhuDetail_User: any[] = [[],[],[],[]];
