...
var Main = (function (_super) {
    ...
    Main.prototype.onResourceLoadComplete = function (event) {
        ...
        if (event.groupName == "loading") {
            ...
            this.checkShowLoading();
            //开始加载开始资源
            RES.loadGroup("yscload");
        }
        else if (event.groupName == "yscload") {
            //数据赋值
    ...
    Main.prototype.checkShowLoading = function () {
        ...
        basic.SceneManager.register(SceneNames.SCENEGAME_YSC, SceneGame_YSC);
    ...
    Main.prototype.startCreateScene = function () {
        ...
        if (LoaderData.is_Start_Show == false) {
            //显示开始界面
            basic.SceneManager.show(SceneNames.SCENEGAME_YSC, null, basic.sceneEffect.Fade);
        }
        //数据赋值
