...
module basic {
    export class SceneManager {
        ...
        //添加底部场景
        static addBottomScene(name: string): void {
            SceneManager.instance.addBottomScene(name);
        }
        
        //添加底部场景
        static removeBottomScene(name: string): void {
        ...
        mapBottomScene: HashMap;//Top场景数据
        ...
        constructor() {
            ...
            this.mapBottomScene = new HashMap();
        }
        ...
        //添加底部场景
        addBottomScene(name: string): void {
            //判断显示顶部场景
        ...
        //移除底部场景
        removeBottomScene(name: string): void {
            //判断移除顶部场景
            if(this.mapBottomScene.containsKey(name)) {
                //显示前调用
