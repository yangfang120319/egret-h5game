 ...
 *
 */
class YSC_OverShow extends eui.Component {
    //定义变量
    ...
    private start_show_x: number[] = [];
    private start_show_y: number[] = [];
    private _tween_x_show: egret.Tween = null;
    private _tween_y_show: egret.Tween = null;
    private _tween_alpha_show: egret.Tween = null;
    private _tween_scaleX_show: egret.Tween = null;
    private _tween_scaleY_show: egret.Tween = null;
    ...
    //初始化界面
    info(_play_x: number,_play_y: number,_play_rate: number): void {
        //数据赋值
    ...
    //显示结束界面
    private onShowOverFace(e:egret.Event):void{
        //停止动画
        this.stopAction();
    ...
    //隐藏结束界面
    private onHideOverFace(e: egret.Event): void {
        //隐藏界面
        this.visible = false;
