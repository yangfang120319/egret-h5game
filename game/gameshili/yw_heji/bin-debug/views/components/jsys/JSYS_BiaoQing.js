 ...
 *
 */
var JSYS_BiaoQing = (function (_super) {
    __extends(JSYS_BiaoQing, _super);
    function JSYS_BiaoQing() {
    ...
    //初始化
    JSYS_BiaoQing.prototype.createChildren = function () {
        ...
        //注册事件
        basic.Dispatcher.addListener(EventNames.JSYS_SHOWBIAOQING, this.onShowFace, this);
        //定义按钮
    ...
    //删除按钮
    JSYS_BiaoQing.prototype.onDeleteBtn = function (e) {
        //播放声音
        basic.SoundManager.instance.playEffect("sound_btn_mp3");
        //发送消息
        basic.Dispatcher.dispatch(EventNames.JSYS_DELETECHAT);
    };
    //表情按钮
    JSYS_BiaoQing.prototype.onBiaoQingBtn = function (e) {
        //定义变量
        var btnnum = Number(e.target.name);
        //播放声音
        basic.SoundManager.instance.playEffect("sound_btn_mp3");
        //发送消息
        basic.Dispatcher.dispatch(EventNames.JSYS_ADDBIAOQING, { "num": btnnum });
    };
    //显示界面
    JSYS_BiaoQing.prototype.onShowFace = function (e) {
        var _this = this;
        //显示界面
    ...
    //当前按钮
    JSYS_BiaoQing.prototype.onThisBtn = function (e) {
        var _this = this;
        //数据赋值
    ...
    //隐藏按钮
    JSYS_BiaoQing.prototype.onHideFace = function (e) {
        var _this = this;
        //数据赋值
        this.is_click = false;
        //判断隐藏界面
    ...
    return JSYS_BiaoQing;
}(eui.Component));
__reflect(JSYS_BiaoQing.prototype, "JSYS_BiaoQing");
