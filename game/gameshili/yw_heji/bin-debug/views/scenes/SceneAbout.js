...
var SceneAbout = (function (_super) {
    ...
    function SceneAbout() {
        ...
        //定义界面
        _this.skinName = SceneAboutSkin;
        //注册按钮
        _this.btn_close.addEventListener(egret.TouchEvent.TOUCH_TAP, _this.onCloseBtn, _this);
        return _this;
    }
    //显示前调用
    SceneAbout.prototype.beforeShow = function () {
    };
    //关闭按钮
    SceneAbout.prototype.onCloseBtn = function (e) {
        //播放声音
...
__reflect(SceneAbout.prototype, "SceneAbout");
