...
(function (basic) {
    var SceneBase = (function (_super) {
        ...
        function SceneBase() {
            ...
            //注册事件
            basic.Dispatcher.addListener(basic.StageProxy.CHANGE_RESIZE, _this.onChangeResize, _this);
            return _this;
        }
        //改变大小
        SceneBase.prototype.onChangeResize = function (e) {
            //显示大小
        ...
        //屏幕适配
        SceneBase.prototype.onShowPlace = function () {
        };
        return SceneBase;
    }(eui.Component));
